...
| [`data_design_patterns.html`](data_design_patterns.html) | HTML rendering of the chapter, generated from the Markdown source. |
...
* [`tools/`](tools) — `build_docs.sh` and its helper files, used to
  ...
  source (see [Regenerating the HTML and PDF](#regenerating-the-html-and-pdf) above).
